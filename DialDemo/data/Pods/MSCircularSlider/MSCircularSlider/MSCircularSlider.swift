...
public class MSCircularSlider: UIControl {
    ...
    public var currentValue: Int {
        set {
            let val = min(max(minimumValue, Double(newValue)), maximumValue)
            handle.currentValue = Int(val)
            ...
            return Int(valueFrom(angle: handle.angle))
        }
    }
    ...
    public var maximumAngle: CGFloat = 360.0 {     // Full circle by default
        didSet {
            ...
            currentValue = Int(valueFrom(angle: angle))
    ...
    internal var isSliding: Bool = true
    ...
    override public func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        if handle.contains(location) {
            ...
            castDelegate?.circularSlider(self, startedTrackingWith: Double(currentValue))
            setNeedsDisplay()
            return true
        }
    ...
    override public func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        castDelegate?.circularSlider(self, valueChangedTo: Double(currentValue), fromUser: true)
    ...
    override public func endTracking(_ touch: UITouch?, with event: UIEvent?) {
        ...
        snapHandle()
        castDelegate?.circularSlider(self, endedTrackingWith: Double(currentValue))
