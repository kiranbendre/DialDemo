...
public class MSDoubleHandleCircularSlider: MSCircularSlider {
    ...
    public var secondCurrentValue: Double {
        set {
            ...
            secondHandle.currentValue = Int(val)
            
            // Update second angle
            secondAngle = angleFrom(value: val)
            
            castDelegate?.circularSlider(self, valueChangedTo: Double(currentValue), secondValue: val, isFirstHandle: nil, fromUser: false)
    ...
    override public func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        if secondHandle.isPressed || handle.isPressed {
            castDelegate?.circularSlider(self, startedTrackingWith: Double(currentValue), secondValue: secondCurrentValue, isFirstHandle: handle.isPressed)
    ...
    override public func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        castDelegate?.circularSlider(self, valueChangedTo: Double(currentValue), secondValue: secondCurrentValue, isFirstHandle: handle.isPressed, fromUser: false)
    ...
    override public func endTracking(_ touch: UITouch?, with event: UIEvent?) {
        castDelegate?.circularSlider(self, endedTrackingWith: Double(currentValue), secondValue: secondCurrentValue, isFirstHandle: handle.isPressed)
    ...
    override func snapHandle() {
        ...
        if snapToLabels {
            ...
            currentValue = Int(valueFrom(angle: newAngle))
        }
